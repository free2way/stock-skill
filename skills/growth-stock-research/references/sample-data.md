...
Use the sample files in `assets/sample-data/` to learn the workflow quickly.

Included files:

- `sample_refresh_manifest.json`
- `sample_nbis_report.json`
- `sample_iren_report.json`
- `sample_nbis_update.txt`
- `sample_iren_update.txt`
